...
for lost_idx, found_idx in matching_pairs:
    lost_to_process = item_to_process(id=losts_train_list[lost_idx]["_id"], item_type="lost", type=losts_train_list[lost_idx]["type"], subtype=losts_train_list[lost_idx]["subtype"], color=losts_train_list[lost_idx]["color"], location=losts_train_list[lost_idx]["location"], date=losts_train_list[lost_idx]["date"], identifiable=losts_train_list[lost_idx]["identifiable"])
    found_to_process = item_to_process(id=founds_train_list[found_idx]["_id"], item_type="found", type=founds_train_list[found_idx]["type"], subtype=founds_train_list[found_idx]["subtype"], color=founds_train_list[found_idx]["color"], location=founds_train_list[found_idx]["location"], date=founds_train_list[found_idx]["date"], identifiable=founds_train_list[found_idx]["identifiable"])
...
for lost_idx, found_idx in matching_test_pairs:
    lost_to_process = item_to_process(id=losts_test_list[lost_idx]["_id"], item_type="lost", type=losts_test_list[lost_idx]["type"], subtype=losts_test_list[lost_idx]["subtype"], color=losts_test_list[lost_idx]["color"], location=losts_test_list[lost_idx]["location"], date=losts_test_list[lost_idx]["date"], identifiable=losts_test_list[lost_idx]["identifiable"])
    found_to_process = item_to_process(id=founds_test_list[found_idx]["_id"], item_type="found", type=founds_test_list[found_idx]["type"], subtype=founds_test_list[found_idx]["subtype"], color=founds_test_list[found_idx]["color"], location=founds_test_list[found_idx]["location"], date=founds_test_list[found_idx]["date"], identifiable=founds_test_list[found_idx]["identifiable"])
    prepared = data_transformer.prepare_data(lost_to_process, found_to_process)
    prepared_df = pd.DataFrame(prepared, index=[0])
